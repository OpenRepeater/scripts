...
1. Write the IMG file that you downloaded to your SD card. (Instructions: [Windows](https://openrepeater.com/knowledgebase/topic/writing-img-file-on-windows) | [Mac](https://openrepeater.com/knowledgebase/topic/writing-img-file-on-a-mac))

1. Boot and log into using default username and password. For Raspbian: pi/raspberry

1. Enable SSH (via keyboard/console)
	* $ sudo systemctl enable ssh
	* $ sudo systemctl start ssh
1. Setup Root Password (via keyboard/console)
	* $ sudo passwd root
...
* Enable Root on Raspbian for SSH
